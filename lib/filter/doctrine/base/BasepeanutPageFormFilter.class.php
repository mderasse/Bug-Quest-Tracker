...
abstract class BasepeanutPageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'status'     => new sfWidgetFormChoice(array('choices' => array('' => '', 'draft' => 'draft', 'publish' => 'publish'))),
    ...
    $this->setValidators(array(
      ...
      'status'     => new sfValidatorChoice(array('required' => false, 'choices' => array('draft' => 'draft', 'publish' => 'publish'))),
