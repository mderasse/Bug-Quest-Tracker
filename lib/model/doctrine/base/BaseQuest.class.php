 ...
 * @method ClientString        getTrad()       Returns the current record's "Trad" value
 ...
 * @method Quest               setCommentId()  Sets the current record's "comment_id" value
 * @method Quest               setTrad()       Sets the current record's "Trad" value
...
abstract class BaseQuest extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('zone_id', 'string', 150, array(
             'type' => 'string',
             'notnull' => true,
             'length' => 150,
             ));
    ...
    {
        parent::setUp();
        $this->hasOne('ClientString as Trad', array(
             'local' => 'name',
             'foreign' => 'name'));
