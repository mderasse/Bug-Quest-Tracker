...
Pour le reste, le repository ne sera certainement pas complété avant un certain moment. La faute au temps et à cette espèce d'exigence personnelle de livrer quelque chose d'à peu près correct.
...
Toute l'histoire sera à suivre sur [mon blog](http://dev.pockyworld.com).
